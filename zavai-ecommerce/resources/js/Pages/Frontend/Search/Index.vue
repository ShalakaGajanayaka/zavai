...
import ShopLayout from '../../../Layouts/ShopLayout.vue'; // Corrected Path
    ...
    <ShopLayout>
        <div class="bg-white">
            <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Search results for: "{{ query }}"</h1>
                ...
                <div v-else class="mt-8 grid grid-cols-1 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
